...
public class CurveAnalysisController implements Initializable {
    ...
    private Label lx4;
    @FXML
    private Label completeCurve;
    @FXML
    private Label symmetries;
    @FXML
    private Label yAxesCrossing;
    @FXML
    private Label zeroPoints;

    @FXML
    private ArrayList<Double> curValues = new ArrayList<>();
    ...
    @FXML
    public void addCurve(ActionEvent actionEvent) {
